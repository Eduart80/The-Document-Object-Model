...
Enter user name, email, and create a new password, and then re-enter the same password for verification.<br>
...
### Read
On page reload card will show on UI if there is data on localstorage
### Update
User is able to edit the text are and update the local storage with this new data.
### Delete
